...
<section class="dash-section">
  <div class="container">
    <a href="{{ route('mon-espace.commandes.show', $commande) }}" class="back-link">
    ...
    <div class="auth-card" style="max-width:560px;">
      ...
      <p class="sub">Commande #{{ $commande->id_commande }} — {{ $commande->annonce->titre }}</p>
      ...
      <div class="geoloc-status" style="margin-bottom:20px;">
        🔒 Ce montant sera détenu en séquestre par ElevConnect et versé au fournisseur
