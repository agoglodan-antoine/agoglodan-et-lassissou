...
<section class="dash-section">
  <div class="container" style="max-width:700px;">
    <a href="{{ route('mon-espace.commandes.index') }}" class="me-back">
    ...
    <div class="dash-card">
      ...
      @if (! $commande->estRetraitDirect() && $commande->statut === 'livree')
        <div class="dash-card" style="background:var(--sand);box-shadow:none;">
          ...
          <form method="POST" action="{{ route('mon-espace.commandes.confirmer-reception', $commande) }}" style="display:flex;gap:10px;">
            @csrf
