          ...
          <div style="flex:1;">
            ...
            <div class="dash-actions">
              @if ($commande->statut === 'payee')
                <form method="POST" action="{{ route('mon-espace.commandes-recues.prendre-en-charge', $commande) }}">
                  @csrf
              ...
              @if ($commande->statut === 'en_cours_de_traitement')
                <form method="POST" action="{{ route('mon-espace.commandes-recues.valider', $commande) }}">
                  @csrf
            ...
            @if (in_array($commande->statut, ['payee', 'en_cours_de_traitement']))
              <form method="POST" action="{{ route('mon-espace.commandes-recues.refuser', $commande) }}" class="moderation-reject-form" id="refuse-{{ $commande->id_commande }}" style="display:none;">
                @csrf
