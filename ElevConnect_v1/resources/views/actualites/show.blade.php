...
<section class="dash-section">
  <div class="container" style="max-width:800px;">
    <a href="{{ route('actualites.index') }}" class="back-link">
    ...
    <div class="dash-card">
      ...
      @can('update', $actualite)
        <div class="dash-actions" style="margin-top:28px;">
          <a href="{{ route('mon-espace.actualites.edit', $actualite) }}" class="btn btn-ghost-dark btn-sm">Modifier</a>
          <form method="POST" action="{{ route('mon-espace.actualites.destroy', $actualite) }}" onsubmit="return confirm('Supprimer cette actualité ?');">
            @csrf @method('DELETE')
