...
class RendezVousPolicy
{
    ...
    /** L'éleveur dépose un avis et une note une fois le rendez-vous réalisé. */
    public function noter(Utilisateur $utilisateur, RendezVous $rdv): bool
    {
        return $utilisateur->id_utilisateur === $rdv->id_eleveur
            && $rdv->statut === RendezVous::REALISE;
    }
