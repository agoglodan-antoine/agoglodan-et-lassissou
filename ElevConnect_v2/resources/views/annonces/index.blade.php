...
@section('title', 'Mon catalogue — ElevConnect')
...
<section class="dash-section">
  <div class="container">
    <div class="dash-head">
      ...
      <a href="{{ route('mon-espace.annonces.create') }}" class="btn btn-primary">+ Nouvelle annonce</a>
    </div>
    ...
    <div class="dash-card" style="padding:0;">
      @if ($annonces->isEmpty())
        <div class="empty-state">
          ...
          <br><a href="{{ route('mon-espace.annonces.create') }}" class="btn btn-ghost-dark" style="margin-top:16px;display:inline-flex;">Publier ma première annonce</a>
        </div>
      @else
          ...
          <tbody>
            @foreach ($annonces as $annonce)
              <tr>
                ...
                <td><x-status-pill :status="$annonce->statut" /></td>
                <td>{{ $annonce->date_publication->format('d/m/Y') }}</td>
                <td>
                  <div class="dash-actions">
                    <a href="{{ route('mon-espace.annonces.show', $annonce) }}" class="btn btn-ghost-dark btn-sm">Voir</a>
