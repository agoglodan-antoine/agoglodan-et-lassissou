  ...
  <div class="container">
    <div class="listings-head">
      <div class="section-head" style="margin-bottom:0;">
        ...
        <a href="{{ route('catalogue.index') }}" style="font-weight:700;color:var(--clay-dark);">Voir toutes les annonces <i class="fa-solid fa-arrow-right"></i></a>
      </div>
    </div>

    <div class="listings-carousel">
      <button id="scrollLeft" class="carousel-arrow carousel-arrow-left" aria-label="Précédent"><i class="fa-solid fa-chevron-left"></i></button>
      ...
      <button id="scrollRight" class="carousel-arrow carousel-arrow-right" aria-label="Suivant"><i class="fa-solid fa-chevron-right"></i></button>
    </div>
  </div>
</section>
...
{{-- PRICING — corrigé : l'abonnement est réservé aux VÉTÉRINAIRES uniquement
     ...
     Masqué pour un utilisateur connecté dont le rôle n'est pas vétérinaire. --}}
  ...
  <div class="container">
    ...
    <div class="pricing-grid">
      <div class="price-card">
        ...
        @auth
          <a href="{{ route('mon-espace.abonnement.show') }}" class="btn btn-ghost-dark">Voir mon abonnement</a>
        @else
      ...
      <div class="price-card premium">
        ...
        @auth
          <a href="{{ route('mon-espace.abonnement.show') }}" class="btn btn-primary">Passer en Premium</a>
        @else
  ...
  <div class="container">
    ...
    <div class="testi-grid">
      <div class="testi-card">
        ...
        <p>« Je publie Mon catalogue en quelques minutes depuis mon téléphone, et je suis payé directement une fois la livraison confirmée. »</p>
        <div class="testi-who">
...
<section class="section" style="background:var(--sand);" id="actualites">
  <div class="container">
    <div class="section-head">
      ...
      <a href="{{ route('actualites.index') }}" style="font-weight:700;color:var(--clay-dark);">Voir toutes les actualités <i class="fa-solid fa-arrow-right"></i></a>
    </div>
    <div class="news-grid">
      @forelse ($actualites as $actualite)
        <article class="news-card">
          ...
          <div class="news-body">
            ...
            <a class="news-link" href="{{ route('actualites.show', $actualite) }}">Lire l'article <i class="fa-solid fa-arrow-right"></i></a>
          </div>
        </article>
      @empty
        <article class="news-card">
