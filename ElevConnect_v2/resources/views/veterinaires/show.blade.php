...
<section class="dash-section">
  <div class="container" style="max-width:800px;">
    <div class="dash-card">
      <x-back-link :href="route('veterinaires.index')" label="Retour aux vétérinaires" />
      <div class="dash-head" style="margin-bottom:20px;">
        <div>
          ...
          @if ($veterinaire->note_moyenne)
            <p style="color:var(--clay-dark);font-weight:700;margin-top:6px;"><i class="fa-solid fa-star"></i> {{ number_format($veterinaire->note_moyenne, 1) }} ({{ $veterinaire->nombre_avis }} avis)</p>
          @endif
        </div>
