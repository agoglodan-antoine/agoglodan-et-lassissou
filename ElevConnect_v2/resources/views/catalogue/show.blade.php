...
<section class="dash-section">
  <div class="container" style="max-width:900px;">
    <div class="dash-card">
      <x-back-link :href="route('catalogue.index')" label="Retour aux annonces" />
      ...
      <x-status-pill force="visible" :label="ucfirst($annonce->type_annonce)" style="margin-bottom:12px;" />
