...
<header class="site-header" id="siteHeader">
  <div class="container nav-row">
    ...
    <div class="nav-actions">
      ...
      @auth
        <a href="{{ route('mon-espace.notifications.index') }}" class="btn btn-ghost-dark" title="Notifications"><i class="fa-solid fa-bell"></i></a>
        <a href="{{ route('mon-espace.dashboard') }}" class="btn btn-ghost-dark">Mon espace</a>
   ...
   <div class="mp-collapse">
    <div class="mp-body">
      ...
      <div class="mp-actions">
        @auth
          <a href="{{ route('mon-espace.notifications.index') }}" class="btn btn-ghost-dark"><i class="fa-solid fa-bell"></i> Notifications</a>
          <a href="{{ route('mon-espace.dashboard') }}" class="btn btn-ghost-dark">Mon espace</a>
        @else
          <a href="{{ route('login') }}" class="btn btn-ghost-dark">Connexion</a>
          <a href="{{ route('register') }}" class="btn btn-primary">Créer un compte</a>
...
<div class="search-modal-overlay" id="searchModalOverlay" role="dialog" aria-modal="true" aria-label="Recherche générale">
  <div class="search-modal">
    <button type="button" class="search-modal-close" id="closeSearchBtn" aria-label="Fermer"><i class="fa-solid fa-xmark"></i></button>
