        ...
        <div class="moderation-card">
          <div style="flex:1;">
            ...
            <div class="dash-actions">
              <a href="{{ route('mon-espace.commandes-fournisseur.show', $commande) }}" class="btn btn-ghost-dark btn-sm">Voir le détail</a>
            ...
            @if (in_array($commande->statut, ['payee', 'en_cours_de_traitement']))
              <form method="POST" action="{{ route('mon-espace.commandes-fournisseur.refuser', $commande) }}" class="moderation-reject-form" id="refuse-{{ $commande->id_commande }}" style="display:none;">
                @csrf
