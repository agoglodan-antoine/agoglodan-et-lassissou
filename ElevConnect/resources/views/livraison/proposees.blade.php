        ...
        <div class="moderation-card">
          <div style="flex:1;">
            ...
            <div class="dash-actions" style="align-items:flex-end;">
              ...
              <form method="POST" action="{{ route('livraison.rejeter', $livraison) }}" onsubmit="return confirm('Refuser cette livraison ? Elle sera proposée à un autre livreur disponible.');">
                @csrf
