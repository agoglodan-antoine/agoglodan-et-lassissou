    ...
    <div class="dash-head">
      <div>
        ...
        <p>
          ...
          @endif
          — <a href="{{ route('abonnement.show') }}">gérer mon abonnement</a>
        </p>
      </div>
      @if (! $limiteAtteinte)
        <a href="{{ route('services.create') }}" class="btn btn-primary">+ Nouveau service</a>
      @else
        <a href="{{ route('abonnement.show') }}" class="btn btn-primary">Passer en Premium pour en ajouter</a>
      @endif
    </div>
    ...
    <div class="dash-card" style="padding:0;">
      @if ($services->isEmpty())
        <div class="empty-state">
          ...
          <br><a href="{{ route('services.create') }}" class="btn btn-ghost-dark" style="margin-top:16px;display:inline-flex;">Publier mon premier service</a>
        </div>
      @else
              ...
              <tr>
                ...
                <td>
                  <div class="dash-actions">
                    <a href="{{ route('services.edit', $service) }}" class="btn btn-ghost-dark btn-sm">Modifier</a>
